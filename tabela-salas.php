  ...
  <table class="schedule-table table table-dark">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="background-color: var(--secondary-color);"><h4 style="color: white">DB1</h4>[Empresa]</td>
        <td style="background-color: var(--secondary-color);"><h4 style="color: white">ItalenTI</h4>[Empresa]</td>
